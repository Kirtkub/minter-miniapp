...
const walletItem$1 = { "walletOn": "Wallet in", "recent": "Recent", "installed": "Installed", "new": "New" };
...
const walletItem = { "walletOn": "Wallet в", "recent": "Недавний", "installed": "Установлен", "new": "Новый" };
...
const tonConnectUiVersion = "3.0.2";
